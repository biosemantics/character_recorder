                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div v-if="currentTermType == 1" style="margin-left: 15px; width: 100%;">
                            <div class="row" v-for="eachTerm in deprecatedTerms" :key="eachTerm" style="text-align: left">
                                <div class="col-md-10">
                        ...
                        <div v-if="currentTermType == 2" style="margin-left: 10px; width: 100%;">
                            ...
                            <div class="row" v-for="eachTerm in newSuperClassTerms" :key="eachTerm" style="text-align: left">
                                <div class="col-md-10">
                                    <div>
                        ...
                        <div v-if="currentTermType == 3" style="margin-left: 10px; width: 100%;">
                            ...
                            <div class="row" v-for="eachTerm in newDefinitionTerms" :key="eachTerm" style="text-align: left">
                                <div class="col-md-10">
                                    <div>

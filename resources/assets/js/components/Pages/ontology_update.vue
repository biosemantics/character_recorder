              ...
              <div class="row" v-for="(eachTerm, index) in deprecatedTerms" :key="index" style="text-align: left">
                <div class="col-md-10">
                  <div v-if="eachTerm['tagName'] && eachTerm['tagName'] != ''">
                    <a
                      v-on:click="handleClickDeprecatedTerm(eachTerm['tagName'])"><b>{{ eachTerm['deprecate term'] }}</b></a>
                  </div>
                  <div v-else>
                  ...
                  <div style="margin-left:20px;">
                    <div>
                      Deprecated Reason: <span
                      style="font-style: italic;font-weight:500;word-break: break-all;"> {{ eachTerm['deprecated reason'] }}</span>
                    </div>
                    <div v-if="eachTerm['replacement term'] && eachTerm['replacement term'] != ''">
                      Replacement Term: <span
                      style="font-style: italic;font-weight:500;word-break: break-all;"> {{ eachTerm['replacement term'] }}</span>
                    </div>
                  </div>
                </div>
                <div class="col-md-2">
                ...
                <div class="col-md-10">
                  ...
                  <div style="margin-left:20px;">
                    <div v-if="eachTerm['moved term'] && eachTerm['moved term'] != ''">
                      Moved term: <span
                      style="font-style: italic;font-weight:500;word-break: break-all;"> {{ eachTerm['moved term'] }}</span>
                    </div>
                    <div v-if="eachTerm['moved term IRI'] && eachTerm['moved term IRI'] != ''">
                      Moved term IRI: <span
                      style="font-style: italic;font-weight:500;word-break: break-all;"> {{ eachTerm['moved term IRI'] }}</span>
                    </div>
                    <div v-if="eachTerm['editor_note'] && eachTerm['editor_note'] != ''">
                      Note: <span
                      style="font-style: italic;font-weight:500;word-break: break-all;"> {{ eachTerm['editor_note'] }}</span>
                    </div>
                    <div v-if="eachTerm['example_of_usage'] && eachTerm['example_of_usage'] != ''">
                      Example of usage: <span
                      style="font-style: italic;font-weight:500;word-break: break-all;"> {{ eachTerm['example_of_usage'] }}</span>
                    </div>
                  </div>
                </div>
                <div class="col-md-2">
                ...
                <div class="col-md-10">
                  ...
                  <div style="margin-left:20px;">
                    ...
                    <div v-if="eachTerm['term with new def IRI'] && eachTerm['term with new def IRI'] != ''">
                      Term with new definition IRI: <span
                      style="font-style: italic;font-weight:500;word-break: break-all;"> {{ eachTerm['term with new def IRI'] }}</span>
                    </div>
                    <div v-if="eachTerm['definition'] && eachTerm['definition'] != ''">
                      Definition: <span
                      style="font-style: italic;font-weight:500;word-break: break-all;"> {{ eachTerm['definition'] }}</span>
                    </div>
                    <div v-if="eachTerm['editor_note'] && eachTerm['editor_note'] != ''">
                      Note: <span
                      style="font-style: italic;font-weight:500;word-break: break-all;"> {{ eachTerm['editor_note'] }}</span>
              ...
              <div style="max-height:80vh; overflow-y: auto;">
                ...
                <div class="modal-body">
                  <div style="margin-top: 0px;">
                    ...
                    <textarea v-bind:placeholder="promptText"
                              style="margin-top:15px;border-radius: 5px; border: 1px solid; padding: 15px; width: 100%;"
...
export default {
  ...
  methods: {
    ...
    handleMessageDeprecated(eachTerm) {
      ...
      app.deprecatedIRI = eachTerm['deprecated IRI'];
